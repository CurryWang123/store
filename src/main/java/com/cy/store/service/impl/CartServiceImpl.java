...
//        }
    ...
    @Override
    public void updateNumByCid(Integer cid, Integer num,String modifiedUser) {
        Date date = new Date();
        int i = cartMapper.updateNumByCid(cid,num,modifiedUser,date);
    }

    @Override
    public void deleteCart(int[] cidList) {
        cartMapper.deleteCart(cidList);
    }
}
